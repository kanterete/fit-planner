...
import { Exercise, WeekDay, WorkoutPlan } from "@/types/types";
...
const DashBoard = () => {
  ...
  return (
    <main className="p-4 mx-auto my-4 container h-fit flex flex-col">
      ...
      <section className="w-fit h-100">
        <h1 className="text-2xl md:text-3xl font-semibold">
          Create your own workout:
        </h1>
        <form className="h-full w-full flex flex-col gap-2 ">
          <div className="flex flex-col mb-4 w-1/2">
            <label className="mr-2">Training name:</label>
            <input
              type="text"
              name="name"
              id=""
            ...
            input.map((inp) => (
              ...
              >
                <div className="flex items-center">
                  <p className="border-1 border-primary border-dashed p-1 rounded-lg">
                    {inp.name}
                  </p>
                </div>
                x
          ...
          <label className="mr-2">Add exercise:</label>
          <div className="flex w-full items-center gap-2 border-1 border-dashed border-primary  rounded-lg">
            <div className="flex items-center">
              <input
                type="text"
                name="name"
            ...
            <Button
              ...
              onClick={(e) => {
                ...
                if (!name || !reps || !sets || !weight)
                  ...
                  setInputs((prev) => [
                    ...prev,
                    { id: `e${prev.length + 1}`, name, reps, sets, weight },
                  ]);
